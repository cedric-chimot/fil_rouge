...
if(isset($_GET['delete'])){
    ...
    header('location:commandes_reglees.php');
}
...
<body>
    ...
    <section class="commandes">
        ...
        <h1 class="titre">Commandes terminées</h1>

        <div class="box-container">
            <?php
                //connexion à la table 'commande' dans la BDD
                //requête pour selectionner la colonne 'statut_paiement' avec le paramètre 'completee'
