...
if(isset($_POST['update_commande'])){
    ...
    $update_num_commande = $_POST['num_commande'];
    ...
    mysqli_query($con, "UPDATE `commande`
        ...
        WHERE num_commande = '$update_num_commande'")
...
if(isset($_GET['delete'])){
    ...
    $delete_num_commande = $_GET['delete'];
    //requête de suppression avec lien vers la table 'commande'
    mysqli_query($con, "DELETE FROM `commande` WHERE id = '$delete_num_commande'")
    or exit('Echec de la requête');
...
<body>
    ...
    <section class="commandes">
        ...
        <h1 class="titre">Commandes expédiées</h1>
        ...
        <div class="box-container">
            <?php
                ...
                $select_commandes = mysqli_query($con, "SELECT * FROM `commandes`
                    WHERE statut_commande = 'expediee'")
                    or exit("Echec de la requête");
            ...
            <div class="box">
                ...
                <form action="" method="post">
                    <input type="hidden" name="num_commande"
                        value="<?php echo $fetch_commande['num_commande']; ?>">
                    ...
                    <a href="recap_commandes.php?delete=<?php echo $fetch_commande['num_commande']; ?>"
